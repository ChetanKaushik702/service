...
export const updateProfile = (userData) => async (dispatch) => {
    try{
        ...
        dispatch({type: UPDATE_PROFILE_FAIL, payload: error.response?.data?.message || "Something went wrong. Please try again."});
    }
};
...
export const updatePassword = (passwords) => async (dispatch) => {
    try{
        ...
        dispatch({type: UPDATE_PASSWORD_FAIL, payload: error.response?.data?.message || "Something went wrong. Please try again."});
    }
};
